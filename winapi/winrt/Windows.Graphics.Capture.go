...
// VTable 函数的作用是将接口的 RawVTable 转换为 IGraphicsCaptureSessionVtbl 类型
...
//func (v *IGraphicsCaptureSession) IsSupport() bool {
//	r1, _, _ := syscall.SyscallN(v.VTable().IsSupport, uintptr(unsafe.Pointer(v)))
//	if r1 != win.S_OK {
//		return false
//	}
//	return true
